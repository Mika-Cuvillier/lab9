...
<!-- //////////////////////////////////////////////////////////////////////////////////  Carrousel -->			
			<?php while ( have_posts() ) : 
				the_post();	
				echo "<p>current_post = " . $query->current_post . "</p>";
				get_propriété($tProp);
				if ($tProp['type_de_cours'] ==  "Web"): 
...
<!-- //////////////////////////////////////////////////////////////////////////////////  Jeu -->
			<h2>Jeu</h2>
			<section class="type-cours Spécifique">
			<?php rewind_posts(); 	
			while ( have_posts() ) : 
				the_post();	
				get_propriété($tProp);		
				if ($tProp['type_de_cours'] ==  "Jeu" ):
...
<!-- //////////////////////////////////////////////////////////////////////////////////  Spécifique -->
			...
			while ( have_posts() ) : 
				the_post();	
				get_propriété($tProp);		
				if ($tProp['type_de_cours'] ==  "Spécifique" ):
					get_template_part( 'template-parts/content', 'article-cours' ); 
				endif;
			endwhile; ?>
			</section>
<!-- //////////////////////////////////////////////////////////////////////////////////  Image2d3d -->
			<h2>Image 2D/3D</h2>
			<section class="type-cours Image2d3d">
			<?php rewind_posts(); 	
			while ( have_posts() ) : 
				the_post();	
				get_propriété($tProp);		
				if ($tProp['type_de_cours'] ==  "Image 2d/3d" ):
					get_template_part( 'template-parts/content', 'article-cours' ); 
				endif;
			endwhile; ?>
			</section>
<!-- //////////////////////////////////////////////////////////////////////////////////   Conception -->
			<h2>Conception</h2>
			<section class="type-cours Conception">
			<?php rewind_posts(); 	
			while ( have_posts() ) : 
				the_post();	
				get_propriété($tProp);		
				if ($tProp['type_de_cours'] ==  "Conception" ):
					get_template_part( 'template-parts/content', 'article-cours' ); 
				endif;
			endwhile; ?>			
			</section>
